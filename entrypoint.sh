...
lftp $WDEFAULT_METHOD://$FTP_SERVER -u $FTP_USERNAME,$FTP_PASSWORD -e "set ssl:verify-certificate false; mirror --reverse --continue --dereference -x ^\.git/$ $WDEFAULT_LOCAL_DIR $WDEFAULT_REMOTE_DIR; quit"
